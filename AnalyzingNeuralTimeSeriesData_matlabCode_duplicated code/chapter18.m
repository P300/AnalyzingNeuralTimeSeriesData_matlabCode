...
load C:\Users\YUXC9N\Desktop\TFA\matfile\singletrial\730oddball_freq
load C:\Users\YUXC9N\Desktop\TFA\matfile\singletrial\730oddball_novl
load C:\Users\YUXC9N\Desktop\TFA\matfile\singletrial\730oddball_target
% wavelet parameters
min_freq = 2;
max_freq = 80;
num_frex = 30;
...
fft_data = fft(squeeze(EEG.data(62,:,1)),n_conv_pow2); %plot channel 62, trial 1
...
set(gca,'ytick',ytickskip,'yticklabel',round(frequencies(ytickskip)),'ydir','normal','xlim',[-200 800],'clim',[0 5000])
xlabel('Time (ms)'), ylabel('Frequency (Hz)')
title('Color limit of 0 to 5000')

subplot(222)
imagesc(EEG.times,[],tf_data)
set(gca,'ytick',ytickskip,'yticklabel',round(frequencies(ytickskip)),'ydir','normal','xlim',[-200 800],'clim',[0 800])
title('Color limit of 0 to 800')

subplot(223)
imagesc(EEG.times,[],tf_data)
set(gca,'ytick',ytickskip,'yticklabel',round(frequencies(ytickskip)),'ydir','normal','xlim',[-200 800],'clim',[0 25])
title('Color limit of 0 to 25')

subplot(224)
imagesc(EEG.times,[],log10(tf_data))
set(gca,'ytick',ytickskip,'yticklabel',round(frequencies(ytickskip)),'ydir','normal','xlim',[-200 800],'clim',[-4 4])
